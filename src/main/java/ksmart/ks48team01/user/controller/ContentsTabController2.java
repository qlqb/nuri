...
//public class ContentsTabController2 {
//
...
//
//    public ContentsTabController2(ContentsService contentsService, AreaService areaService) {
//        this.contentsService = contentsService;
//        this.areaService = areaService;
//    }
//
//    @GetMapping("/tab/{tabCate}")
...
//                              @PathVariable(name="tabCate") String tabCate ){
//
//        log.info("tabCate : {}", tabCate);
...
//
//        return "user/contents/contentsInfoList/"+ tabCate;
//    }
//
//    @GetMapping("/tab1")
...
//
//
//        return "user/contents/contentsInfoList/tab2";
//    }
//*/
